  ...
  readonly tabs: HomeTab[] = [
    {
      ...
      actions: [
        ...
        { id: 'reports', label: 'Báo cáo doanh thu', icon: 'bar-chart-outline', color: '#2dd55b', path: '/module/report' },
        { id: 'debts', label: 'Công nợ', icon: 'document-text-outline', color: '#ff7043', path: '/debt' },
        { id: 'quotes', label: 'Báo giá', icon: 'receipt-outline', color: '#5c6bc0', path: '/module/quote' },
    ...
    },
    {
      ...
      actions: [
        ...
        { id: 'received', label: 'Nhập hàng', icon: 'download-outline', color: '#e6bf00', path: '/module/received-note' },
        { id: 'transfer', label: 'Chuyển hàng', icon: 'arrow-redo-outline', color: '#2dd55b', path: '/module/transfer-note' },
        { id: 'delivery', label: 'Giao hàng', icon: 'boat-outline', color: '#ff7043', path: '/module/delivery-note' },
        { id: 'stock-check', label: 'Kiểm kho', icon: 'layers-outline', color: '#5c6bc0', path: '/module/stock-check' },
    ...
    },
    {
      ...
      actions: [
        ...
        { id: 'accounts', label: 'Sổ tiền', icon: 'wallet-outline', color: '#47bdb5', path: '/module/money-account' },
        { id: 'trades', label: 'Giao dịch', icon: 'swap-horizontal-outline', color: '#e6bf00', path: '/trade' },
        { id: 'income', label: 'Báo cáo thu', icon: 'trending-up-outline', color: '#2dd55b', path: '/module/report-income' },
        { id: 'expense', label: 'Báo cáo chi', icon: 'trending-down-outline', color: '#ff7043', path: '/module/report-expense' },
        { id: 'categories', label: 'Danh mục', icon: 'list-outline', color: '#5c6bc0', path: '/module/trade-category' },
        { id: 'categories-report', label: 'BC theo nhóm', icon: 'bar-chart-outline', color: '#ec407a', path: '/module/category-report' },
        { id: 'timely', label: 'BC theo thời gian', icon: 'analytics-outline', color: '#26c6da', path: '/module/timely-report' },
      ],
    },
    {
      id: 'contacts',
      ...
      actions: [
        ...
        { id: 'staff', label: 'Nhân viên', icon: 'person-outline', color: '#47bdb5', path: '/module/staff' },
    ...
    },
    {
      ...
      label: 'CRM',
      actions: [
        { id: 'crm-leads', label: 'Leads', icon: 'people-outline', color: '#6030ff', path: '/module/crm-leads' },
        { id: 'crm-pipeline', label: 'Pipeline', icon: 'git-branch-outline', color: '#47bdb5', path: '/module/crm-pipeline' },
        { id: 'crm-deals', label: 'Deals', icon: 'hand-left-outline', color: '#e6bf00', path: '/module/crm-deals' },
    ...
    },
    {
      ...
      label: 'Cấu hình',
      actions: [
        { id: 'store', label: 'Cửa hàng', icon: 'storefront-outline', color: '#6030ff', path: '/module/store' },
        ...
        { id: 'help', label: 'Trợ giúp', icon: 'help-circle-outline', color: '#5c6bc0', path: '/module/help' },
        { id: 'settings', label: 'Cài đặt', icon: 'settings-outline', color: '#ec407a', path: '/module/config' },
