...
export class IntegrationsService {
  ...
  readonly providers: ProviderMeta[] = [
    ...
    },
    {
      provider: 'ai',
      name: 'Dịch vụ AI',
      description: 'Tạo nội dung, gợi ý giá và mô tả sản phẩm bằng AI.',
      fields: [
        { key: 'base_url', label: 'API Base URL', placeholder: 'https://api.example.com/v1' },
        { key: 'model', label: 'Model', placeholder: 'gpt-4o-mini' },
        { key: 'api_key', label: 'API Key', type: 'password' },
      ],
      requirement: 'Cần API key của nhà cung cấp AI (không lưu ở frontend production).',
    },
  ];
